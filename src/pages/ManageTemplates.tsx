import { MilestoneOutcomeEditor } from '../components/MilestoneOutcomeEditor';
              ...
              <button
                ...
                title={
                  item.isFinalOutcomeMilestone
                    ? 'Turn off outcome recording for this milestone; existing results are preserved'
                    : 'Record a result for this milestone using its own outcome choices'
                }
          ...
          {milestones
            ...
            .map((item) => (
              ...
              >
                ...
                <MilestoneOutcomeEditor milestone={item} />
              </div>
            ))}
        </div>

        <p className="text-xs text-gray-400">
          Enable outcomes for any milestone and define the choices appropriate to that evaluation.
          Each gets its own statistics. Repeatable milestones keep an attempt history.
          Evaluation results never automatically release or graduate a dog.
        </p>
      </div>
